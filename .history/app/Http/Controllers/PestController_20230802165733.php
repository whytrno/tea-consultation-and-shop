...
class PestController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'pest' => 'required|max:255|unique:pests,pest',
            'image' => 'required|image|mimes:jpg,png,jpeg',
            'pest_detail' => 'required|string',
        ...
        $product = Pest::create([
            'pest' => $request->pest,
            'image' => $image_name,
            'pest_detail' => $request->pest_detail,
    ...
    public function update(Request $request, $id)
    {
        ...
        $data->update([
            'pest' => $request->pest ?? $data->pest,
            'image' => $image_name ?? $data->image,
            'pest_detail' => $request->pest_detail ?? $data->pest_detail,
