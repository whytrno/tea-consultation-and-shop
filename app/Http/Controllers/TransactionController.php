...
class TransactionController extends Controller
{
    ...
    {
        $data = Transaction::where('user_id', Auth::user()->id)->with('transactionProducts.cart.product')->get();
    ...
    public function store(Request $request)
    {
        ...
        $transaction = Transaction::create([
            ...
            'sent_to_name' => $request->sent_to_name ?? Auth::user()->name,
    ...
    {
        $data = Transaction::with('transactionProducts.cart.product')->find($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('approval_file')) {
            ...
            $image = $request->file('approval_file');
    ...
    public function updateStatus(Request $request, $id)
    {
        ...
        if ($request->status == 'success' && $data->approval_file == null) {
            return $this->failedResponse('Approval file is required', 422);
        }
